...
class DatabaseManager():
    ...
    items_column_map = {
        ...
        'item_date_accessioned': 'Date Accessioned',
        'item_date_issued': 'Date Issued',
        'item_url': 'Item URL',
        'views_last_month': 'Item views last month',
        'views_academic_year': 'Item views in academic year',
        'views_total': 'Total item views',
            ...
            with db.cursor() as cursor:
                ...
                commands = (
                    ...
                    CREATE TABLE item_stats (
                        ...
                        item_authors VARCHAR(255) NOT NULL,
                        item_date_accessioned VARCHAR(255) NULL,
                        item_date_issued VARCHAR(255) NULL,
